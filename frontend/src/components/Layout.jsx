      ...
      <header className="border-b bg-white">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center gap-6">
          <Link to="/" className="font-bold">BTPGo</Link>
            ...
            <NavLink to="/alerts" className={navLink}>Alertes<span className="ml-1 inline-block bg-red-600 text-white text-[10px] rounded-full px-1"></span></NavLink>\n            <NavLink to="/status" className={navLink}>Statut</NavLink>
          </nav>
          <div className="ml-auto relative flex items-center gap-2 text-sm">
            ...
            <div className="relative">
              ...
              {showDrop && (
                <div className="absolute right-0 mt-1 w-72 bg-white border rounded shadow">
